...
export default function ReportMatch() {
  ...
  return (
    <div className="flex flex-col w-full min-h-[80vh] items-center justify-center p-4">
      <div className="w-full max-w-lg kaf-card p-6 md:p-8 rounded-3xl border border-kaf-border relative overflow-hidden">
        ...
        {selectedMatch ? (
          <div className="flex items-center justify-between gap-4 mb-10">
            ...
            <div className="flex flex-col items-center flex-1">
              <div className="w-20 h-20 rounded-2xl bg-kaf-panel border-2 border-brand-cyan/50 shadow-[0_0_15px_rgba(0,240,255,0.2)] mb-4 bg-cover" style={{ backgroundImage: `url('https://api.dicebear.com/7.x/avataaars/svg?seed=You')` }}></div>
            ...
            {/* Player B */}
            <div className="flex flex-col items-center flex-1">
              <div className="w-20 h-20 rounded-2xl bg-kaf-panel border-2 border-status-draft/50 mb-4 bg-cover opacity-80" style={{ backgroundImage: `url('https://api.dicebear.com/7.x/avataaars/svg?seed=Opponent')` }}></div>
              ...
              <div className="flex items-center gap-3 bg-kaf-panel rounded-full p-1 border border-kaf-border">
                ...
                <span className="w-8 text-center text-3xl font-black text-status-draft">{scoreB}</span>
        ...
        <button 
          ...
          className="w-full rounded-2xl bg-brand-cyan py-5 font-black text-lg text-kaf-bg transition-all hover:bg-white hover:scale-105 shadow-[0_0_20px_rgba(0,240,255,0.4)] disabled:opacity-50 disabled:hover:scale-100 flex items-center justify-center gap-2"
        >

...
export default function TournamentJoinPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="flex flex-col w-full pb-24 max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      {alreadyRegistered ? (
        <div className="depth-panel rounded-2xl border-green-500/30 bg-green-500/5 p-8 text-center">
        ...
        <div className="space-y-4">
          <div className="depth-panel rounded-2xl p-5 flex items-center gap-4">
          ...
          <div className="depth-panel rounded-2xl p-5 space-y-2 text-sm text-slate-400">
            {[
        ...
        <div className="depth-panel rounded-2xl border-orange-500/30 bg-orange-500/5 p-8 text-center">

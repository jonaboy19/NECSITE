      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 max-w-lg mx-auto">
            <div>
              <div className="text-3xl md:text-4xl font-black text-white">1K+</div>
              <div className="text-xs text-slate-500 uppercase font-bold tracking-widest mt-1">Players</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-brand-cyan">50+</div>
              <div className="text-xs text-slate-500 uppercase font-bold tracking-widest mt-1">Tournaments</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-brand-gold">€5K+</div>
              <div className="text-xs text-slate-500 uppercase font-bold tracking-widest mt-1">Prize Pools</div>
            </div>
          </div>
        </div>

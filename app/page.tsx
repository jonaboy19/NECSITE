    ...
    <main className="min-h-screen overflow-hidden bg-[#020617] text-white">
      <section className="relative mx-auto max-w-7xl px-4 pb-28 pt-6 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center justify-between rounded-2xl border border-cyan-300/10 bg-slate-950/70 px-4 py-3 backdrop-blur">
          <div className="font-black tracking-[0.35em] text-cyan-200">KAF</div>
          <div className="hidden gap-6 text-sm text-slate-300 md:flex">
            <Link href="/tournaments">Tournaments</Link>
            <Link href="/clans">Clans</Link>
            <Link href="/rankings">Rankings</Link>
          </div>
          <Link href="/auth/register" className="rounded-full bg-cyan-400 px-4 py-2 text-sm font-bold text-slate-950">Join</Link>
        </nav>

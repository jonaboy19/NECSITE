...
export function EmptyState({
  ...
  return (
    <div className="depth-panel flex w-full flex-col items-center justify-center rounded-2xl border-dashed px-6 py-16 text-center">
      <div className="depth-stat mb-4 flex h-14 w-14 items-center justify-center rounded-xl text-slate-500">
        <Icon size={30} />
      </div>
